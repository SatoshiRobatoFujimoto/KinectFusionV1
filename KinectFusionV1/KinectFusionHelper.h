...
#include <string>
#include <vector>
/*#include <atlbase.h> // ATL is not included in Visual Studio Express.*/
...
HRESULT WriteBinarySTLMeshFile(INuiFusionColorMesh *mesh, char* lpOleFileName, bool flipYZ = true);
...
HRESULT WriteAsciiObjMeshFile(INuiFusionColorMesh *mesh, char* lpOleFileName, bool flipYZ = true);
...
HRESULT WriteAsciiPlyMeshFile(INuiFusionColorMesh *mesh, char* lpOleFileName, bool flipYZ = true, bool outputColor = false);
